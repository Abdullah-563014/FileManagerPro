...
import filemanager.fileexplorer.adapter.ShareDeviceAdapter;
import filemanager.fileexplorer.service.TransferService;
...
public class ShareDeviceActivity extends ActionBarActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        startTransfer.setAction(TransferHelper.ACTION_START_TRANSFER);
        startTransfer.putExtra(TransferHelper.EXTRA_DEVICE, device);
        startTransfer.putParcelableArrayListExtra(TransferHelper.EXTRA_URIS, buildUriList());
    ...
    public void startDiscovery() {
        mNsdManager.discoverServices(TransferHelper.SERVICE_TYPE, NsdManager.PROTOCOL_DNS_SD, mDiscoveryListener);
    }
