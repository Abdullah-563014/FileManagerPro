...
public class SAFManager {
    ...
    public DocumentFile getDocumentFile(String docId, File file)
        ...
        if(docId.startsWith(ExternalStorageProvider.ROOT_ID_SECONDARY) && Utils.hasLollipop()){
            String newDocId = docId.substring(ExternalStorageProvider.ROOT_ID_SECONDARY.length());
        ...
        } else if(docId.startsWith(UsbStorageProvider.ROOT_ID_USB)){
