package filemanager.fileexplorer.cloud;
...
import static filemanager.fileexplorer.BuildConfig.DROPBOX_CLIENT_ID;
import static filemanager.fileexplorer.BuildConfig.DROPBOX_CLIENT_KEY;
import static filemanager.fileexplorer.BuildConfig.GOOGLE_DRIVE_CLIENT_ID;
...
public class CloudConnection {
    ...
    public final static String GOOGLE_DRIVE_REDIRECT_URI = "filemanager.fileexplorer"+":/oauth2redirect";
    public final static String DROPBOX_REDIRECT_URI = "https://auth.cloudrail.com/"+"filemanager.fileexplorer";
