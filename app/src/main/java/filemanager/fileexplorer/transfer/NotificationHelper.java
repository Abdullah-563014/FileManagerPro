package filemanager.fileexplorer.transfer;
...
import static filemanager.fileexplorer.misc.NotificationUtils.RECEIVE_CHANNEL;
import static filemanager.fileexplorer.misc.NotificationUtils.TRANSFER_CHANNEL;
import static filemanager.fileexplorer.misc.Utils.EXTRA_ROOT;
import static filemanager.fileexplorer.misc.Utils.isWatch;
...
public class NotificationHelper {
    ...
    public NotificationHelper(Service service) {
        ...
        Intent stopIntent = new Intent(TransferHelper.ACTION_STOP_LISTENING);
    ...
    synchronized void updateTransfer(TransferStatus transferStatus, Intent intent) {
        if (transferStatus.isFinished()) {
            ...
            Intent stopIntent = new Intent(mService, TransferService.class)
                    .setAction(TransferHelper.ACTION_STOP_TRANSFER)
                    .putExtra(TransferHelper.EXTRA_TRANSFER, transferStatus.getId());
