...
import filemanager.fileexplorer.misc.LogUtils;
import filemanager.fileexplorer.misc.Utils;
import filemanager.fileexplorer.server.TransferServer;
import filemanager.fileexplorer.transfer.NotificationHelper;
import filemanager.fileexplorer.transfer.TransferHelper;
import filemanager.fileexplorer.transfer.model.Bundle;
import filemanager.fileexplorer.transfer.model.Device;
import filemanager.fileexplorer.transfer.model.FileItem;
import filemanager.fileexplorer.transfer.model.Transfer;

import static filemanager.fileexplorer.transfer.TransferHelper.ACTION_BROADCAST;
import static filemanager.fileexplorer.transfer.TransferHelper.ACTION_REMOVE_TRANSFER;
import static filemanager.fileexplorer.transfer.TransferHelper.ACTION_START_LISTENING;
import static filemanager.fileexplorer.transfer.TransferHelper.ACTION_START_TRANSFER;
import static filemanager.fileexplorer.transfer.TransferHelper.ACTION_STOP_LISTENING;
import static filemanager.fileexplorer.transfer.TransferHelper.ACTION_STOP_TRANSFER;
import static filemanager.fileexplorer.transfer.TransferHelper.EXTRA_DEVICE;
import static filemanager.fileexplorer.transfer.TransferHelper.EXTRA_ID;
import static filemanager.fileexplorer.transfer.TransferHelper.EXTRA_TRANSFER;
import static filemanager.fileexplorer.transfer.TransferHelper.EXTRA_URIS;
import static filemanager.fileexplorer.transfer.TransferHelper.getAssetFileDescriptor;
import static filemanager.fileexplorer.transfer.TransferHelper.getFilename;
import static filemanager.fileexplorer.transfer.TransferHelper.traverseDirectory;
