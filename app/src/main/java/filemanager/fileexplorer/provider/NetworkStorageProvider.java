...
import filemanager.fileexplorer.network.NetworkFile;
...
import static filemanager.fileexplorer.misc.MimeTypes.BASIC_MIME_TYPE;
import static filemanager.fileexplorer.model.DocumentInfo.getCursorInt;
import static filemanager.fileexplorer.provider.ExplorerProvider.ConnectionColumns;
...
public class NetworkStorageProvider extends DocumentsProvider {
    ...
    public void updateConnections() {
        ...
        try {
            ...
            String[] mSelectionArgs = {"%"+ CloudStorageProvider.TYPE_CLOUD+"%"};
    ...
    public Cursor queryRoots(String[] projection) throws FileNotFoundException {
        ...
        synchronized (mRootsLock) {
            ...
            for (Map.Entry<String, NetworkConnection> root : mRoots.entrySet()) {
                ...
                boolean isServer = networkConnection.getType().compareToIgnoreCase(NetworkConnection.SERVER) == 0;
                if(isServer){
