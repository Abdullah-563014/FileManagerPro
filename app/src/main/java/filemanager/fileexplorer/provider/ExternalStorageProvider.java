...
import filemanager.fileexplorer.cursor.MatrixCursor;
import filemanager.fileexplorer.cursor.MatrixCursor.RowBuilder;
import filemanager.fileexplorer.libcore.io.IoUtils;
import filemanager.fileexplorer.misc.DiskInfo;
import filemanager.fileexplorer.misc.FileUtils;
import filemanager.fileexplorer.misc.MimePredicate;
import filemanager.fileexplorer.misc.ParcelFileDescriptorUtil;
import filemanager.fileexplorer.misc.StorageUtils;
import filemanager.fileexplorer.misc.StorageVolume;
import filemanager.fileexplorer.misc.Utils;
import filemanager.fileexplorer.misc.VolumeInfo;
...
import static filemanager.fileexplorer.misc.FileUtils.getTypeForFile;
...
//        final ContentResolver resolver = getContext().getContentResolver();
    ...
    private File getFile(String documentId) throws FileNotFoundException {
        if(documentId.startsWith(UsbStorageProvider.ROOT_ID_USB)){
            return null;
        }
    ...
    private boolean isFromOtherProvider(String documentId){
        return documentId.startsWith(ROOT_ID_SECONDARY) || documentId.startsWith(UsbStorageProvider.ROOT_ID_USB);
    }
}