...
import filemanager.fileexplorer.usb.UsbUtils;



import static filemanager.fileexplorer.misc.FileUtils.getTypeForName;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "filemanager.fileexplorer.action.USB_PERMISSION";
