...
import filemanager.fileexplorer.misc.ImageUtils;
import filemanager.fileexplorer.misc.OsCompat;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "filemanager.fileexplorer.action.DOCUMENTS_PROVIDER";
     ...
     * {@link DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    public static AssetFileDescriptor getDocumentThumbnails(
        ...
        try {
            afd = ContentProviderClientCompat.openTypedAssetFileDescriptor(client, documentUri, "image/*", openOpts, signal);
    ...
    public static AssetFileDescriptor openImageThumbnail(File file) throws FileNotFoundException {
        ...
        try {
            ...
            if (thumb != null) {
                return ContentProviderClientCompat.buildAssetFileDescriptor(pfd, thumb[0], thumb[1], extras);
            }
        } catch (IOException e) {

        }
        return ContentProviderClientCompat.buildAssetFileDescriptor(pfd, 0, AssetFileDescriptor.UNKNOWN_LENGTH, extras);
    }
}
