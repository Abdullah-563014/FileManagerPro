...
/**
 * Representation of a {@link DocumentsContract.Document}.
 */
public class DocumentInfo implements Durable, Parcelable {
    ...
    public void updateFromCursor(Cursor cursor, String authority) {
        ...
        this.path = getCursorString(cursor, DocumentsContract.Document.COLUMN_PATH);
        this.deriveFields();
    }
    ...
    public boolean isThumbnailSupported() {
        return (flags & DocumentsContract.Document.FLAG_SUPPORTS_THUMBNAIL) != 0;
    }
    ...
    public boolean isGridPreferred() {
        return (flags & DocumentsContract.Document.FLAG_DIR_PREFERS_GRID) != 0;
    }

    public boolean isDeleteSupported() {
        return (flags & DocumentsContract.Document.FLAG_SUPPORTS_DELETE) != 0;
    }

    public boolean isMoveSupported() {
        return (flags & DocumentsContract.Document.FLAG_SUPPORTS_MOVE) != 0;
    }

    public boolean isCopySupported() {
        return (flags & DocumentsContract.Document.FLAG_SUPPORTS_COPY) != 0;
    }

    public boolean isRemoveSupported() {
        return (flags & DocumentsContract.Document.FLAG_SUPPORTS_REMOVE) != 0;
    }

    public boolean isRenameSupported() {
        return (flags & DocumentsContract.Document.FLAG_SUPPORTS_RENAME) != 0;
    }

    public boolean isArchiveSupported() {
        return (flags & DocumentsContract.Document.FLAG_SUPPORTS_ARCHIVE) != 0;
    }

    public boolean isBookmarkSupported() {
        return (flags & DocumentsContract.Document.FLAG_SUPPORTS_BOOKMARK) != 0;
    }

    public boolean isWriteSupported() {
        return (flags & DocumentsContract.Document.FLAG_SUPPORTS_EDIT) != 0;
    }

    public boolean isArchive() {
        return (flags & DocumentsContract.Document.FLAG_ARCHIVE) != 0;
    }

    public boolean isPartial() {
        return (flags & DocumentsContract.Document.FLAG_PARTIAL) != 0;
    }
    ...
    public boolean isGridTitlesHidden() {
        return (flags & DocumentsContract.Document.FLAG_DIR_HIDE_GRID_TITLES) != 0;
    }
