...
import filemanager.fileexplorer.common.CursorRecyclerViewAdapter;
import filemanager.fileexplorer.misc.IconColorUtils;
...
public class ConnectionsAdapter extends CursorRecyclerViewAdapter<ConnectionsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(Cursor cursor){
            ...
            if(networkConnection.type.startsWith(CloudStorageProvider.TYPE_CLOUD)){
