package filemanager.fileexplorer.pro.service;
...
import filemanager.fileexplorer.pro.misc.LogUtils;
import filemanager.fileexplorer.pro.misc.Utils;
import filemanager.fileexplorer.pro.server.TransferServer;
import filemanager.fileexplorer.pro.transfer.NotificationHelper;
import filemanager.fileexplorer.pro.transfer.TransferHelper;
import filemanager.fileexplorer.pro.transfer.model.Bundle;
import filemanager.fileexplorer.pro.transfer.model.Device;
import filemanager.fileexplorer.pro.transfer.model.FileItem;
import filemanager.fileexplorer.pro.transfer.model.Transfer;

import static filemanager.fileexplorer.pro.transfer.TransferHelper.ACTION_BROADCAST;
import static filemanager.fileexplorer.pro.transfer.TransferHelper.ACTION_REMOVE_TRANSFER;
import static filemanager.fileexplorer.pro.transfer.TransferHelper.ACTION_START_LISTENING;
import static filemanager.fileexplorer.pro.transfer.TransferHelper.ACTION_START_TRANSFER;
import static filemanager.fileexplorer.pro.transfer.TransferHelper.ACTION_STOP_LISTENING;
import static filemanager.fileexplorer.pro.transfer.TransferHelper.ACTION_STOP_TRANSFER;
import static filemanager.fileexplorer.pro.transfer.TransferHelper.EXTRA_DEVICE;
import static filemanager.fileexplorer.pro.transfer.TransferHelper.EXTRA_ID;
import static filemanager.fileexplorer.pro.transfer.TransferHelper.EXTRA_TRANSFER;
import static filemanager.fileexplorer.pro.transfer.TransferHelper.EXTRA_URIS;
import static filemanager.fileexplorer.pro.transfer.TransferHelper.getAssetFileDescriptor;
import static filemanager.fileexplorer.pro.transfer.TransferHelper.getFilename;
import static filemanager.fileexplorer.pro.transfer.TransferHelper.traverseDirectory;
