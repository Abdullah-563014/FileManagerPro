...
import filemanager.fileexplorer.pro.libcore.util.BiConsumer;
import filemanager.fileexplorer.pro.libcore.util.Consumer;
...
public class IconHelper {
     ...
     */
    public void setViewMode(@BaseActivity.State.ViewMode int mode) {
        mMode = mode;
    ...
    public void load(Uri uri, String docPath, String mimeType, int docFlags, int docIcon, long docLastModified,
        ...
        final boolean allowThumbnail = (mMode == BaseActivity.State.MODE_GRID)
