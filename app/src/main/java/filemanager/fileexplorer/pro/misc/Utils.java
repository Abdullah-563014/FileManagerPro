...
import static filemanager.fileexplorer.pro.setting.SettingsActivity.KEY_PRIMARY_COLOR;

public class Utils extends UtilsFlavour {

    public static final String TAG="Abdullah";
    public static final String lastInterstitialShownTimeKey="LastInterstitialShownTime";
    public static final String interstitialAdsIntervalInHoursKey="InterstitialAdsIntervalInHours";
    public static final String willShowAdsKey="WillShowAds";
    public static int interstitialAdsIntervalInHours=5;
    public static boolean willShowAds=false;
    public static final String versionNameKey="VersionName";
    public static final String versionNumberKey="VersionNumber";
    public static final String versionMessageKey="VersionMessage";
    ...
    public static boolean isAbleToShowAds() {
        long lastTime=PreferenceUtils.getLongPrefs(lastInterstitialShownTimeKey,0);
        interstitialAdsIntervalInHours=PreferenceUtils.getIntegerPrefs(interstitialAdsIntervalInHoursKey,5);
        willShowAds=PreferenceUtils.getBooleanPrefs(willShowAdsKey,false);
        return willShowAds && (((System.currentTimeMillis() - lastTime)) / (1000 * 60 * 60) >= interstitialAdsIntervalInHours);
    }
    ...
    public static void sendEmail(Activity activity, String title, String subject) {
        ...
        result.putExtra(Intent.EXTRA_TEXT, activity.getResources().getString(R.string.app_name)+" Feedback"
