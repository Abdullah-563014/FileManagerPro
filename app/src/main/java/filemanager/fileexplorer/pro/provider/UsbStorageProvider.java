...
import filemanager.fileexplorer.pro.usb.UsbUtils;



import static filemanager.fileexplorer.pro.misc.FileUtils.getTypeForName;
...
public class UsbStorageProvider extends DocumentsProvider {
     ...
     */
    private static final String ACTION_USB_PERMISSION = "filemanager.fileexplorer.pro.action.USB_PERMISSION";
