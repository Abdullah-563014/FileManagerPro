...
import filemanager.fileexplorer.common.ActionBarActivity;
...
import filemanager.fileexplorer.server.WebServer;
...
public abstract class BaseActivity extends ActionBarActivity {
    ...
    private DocumentInfo targetDocumentInfo;
    ...
    private void initAdmobAdsSdk() {
        MobileAds.initialize(this, new OnInitializationCompleteListener() {
            ...
            public void onInitializationComplete(InitializationStatus initializationStatus) {
                initializeAdmobInterstitialAds();
            }
        });
    }

    private void initializeAdmobInterstitialAds() {
        InterstitialAd.load(this,getResources().getString(R.string.admob_interstitial_ads),new AdRequest.Builder().build(),new InterstitialAdLoadCallback(){
            @Override
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                ...
                mInterstitialAds.setFullScreenContentCallback(new FullScreenContentCallback(){
                    ...
                    public void onAdDismissedFullScreenContent() {
                        ...
                        PreferenceUtils.set(Utils.lastInterstitialShownTimeKey,System.currentTimeMillis());
                        if (targetToast!=null && !targetToast.isEmpty()) {
                            Toast.makeText(BaseActivity.this, targetToast, Toast.LENGTH_SHORT).show();
                            targetToast=null;
                        }
                        ...
                        if (targetDocumentInfo!=null) {
                            try {
                                onDocumentPicked(targetDocumentInfo);
                            } catch (Exception e) {
                                Toast.makeText(BaseActivity.this, "Error:- "+e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                            targetDocumentInfo=null;
                        }
                    }
    ...
    public void showInterstitialAds() {
        if (mInterstitialAds != null && Utils.isAbleToShowAds()) {
            mInterstitialAds.show(this);
        }
    }

    public void showInterstitialAds(String toast) {
        targetToast=toast;
        if (mInterstitialAds != null && Utils.isAbleToShowAds()) {
            mInterstitialAds.show(this);
        } else {
    ...
    public void showInterstitialAds(Intent intent) {
        targetIntent=intent;
        if (mInterstitialAds != null && Utils.isAbleToShowAds()) {
            mInterstitialAds.show(this);
        } else {
    ...
    public void showInterstitialAds(DocumentInfo documentInfo) {
        targetDocumentInfo=documentInfo;
        if (mInterstitialAds != null && Utils.isAbleToShowAds()) {
            mInterstitialAds.show(this);
        } else {
            try {
